...
Browser demo URL is supplied in the private judging instructions. The deployed static client has a build-time approved API origin and does not accept arbitrary `?api=` overrides.
